...
class Helper
{
    ...
    {
        foreach (\App\Helpers\Helper::activeLanguages()->pluck('code')->toArray() ?? [] as $index => $item) {
    ...
    public static function localeIsPersian()
    {
        return in_array(self::currentLocale()->code,['fa','sa']);
    }
