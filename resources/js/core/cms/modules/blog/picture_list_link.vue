    ...
    <section>
        <div class="row" :class="{'border-bottom-2 border-bottom-light mb-1': index + 1 < list.length}"
            ...
            <div class="col-12 mb-1">
                <input dir="auto" type="text" class="form-control" placeholder="پیوند ( اختیاری )" v-model="pic.link">
            </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <button @click="addEmptyPic" type="button" class="btn btn-success">افزودن مورد جدید</button>
            </div>
        </div>
        <el-dialog
