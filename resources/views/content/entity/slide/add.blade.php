...
@section('title', 'ثبت اسلاید جدید')

@section('content')
    <section id="vApp">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('cms.slides.store') }}" method="post">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="position" value="{{ old('position',fakeInput(0)) }}"/>
                                    @error('position')
                                    <div class="v-error">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-12">
                                    ...
                                    <pic-single input-name="image"
                                                :current-picture="{{ json_encode(\App\Helpers\Helper::renderPictureArray(old('image'),true)) }}"></pic-single>
                                    @error('image')
                                    <div class="v-error">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-12">
                                    ...
                                    <input class="form-control" dir="ltr" name="url"
                                           value="{{ old('url','https://google.com/slide') }}"/>
                                    @error('url')
                                    <div class="v-error">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="type" class="form-control">
                                        <option value="img" {{ old('type','img') == 'img' ? "selected" : "" }}>
                                            تصویر
                                        </option>
                                        <option value="video" {{ old('type','img') == 'video' ? "selected" : "" }}>
                                            ویدئو
                                        </option>
                                    </select>
                                    @error('type')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="active" class="form-control">
                                        ...
                                        <option value="0" {{ old('active',1) == '0' ? "selected" : "" }}>
                                            غیرفعال
                                        </option>
                                    </select>
                                    @error('active')
