...
@section('content')
    <section id="vApp">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('cms.questions.update',$question) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 form-group">
                                                ...
                                                <input class="form-control" name="{{ $lang->code }}[name]"
                                                       value="{{ old($lang->code . '.name',$question->translateOrNew($lang->code )->name) }}"/>
                                            ...
                                            <div class="col-12 form-group">
                                                ...
                                                <textarea id="e-{{  $lang->code  }}-tt" class="c_editor form-control"
                                                          name="{{ $lang->code }}[description]">{{ old($lang->code . '.description',$question->translateOrNew($lang->code )->description) }}</textarea>
