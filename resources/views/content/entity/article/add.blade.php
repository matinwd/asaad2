...
@section('content')
    <section id="vApp">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('cms.articles.store') }}" method="post">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            @if ($errors->any())
                                    ...
                                    <div class="tab-pane {{ $i == 0 ? "active" : "" }}" id="{{ $lang->code }}_lang">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 form-group">
                                                ...
                                                <input class="form-control" name="{{ $lang->code }}[title]" value="{{ old($lang->code . '.title') }}"/>
                                        ...
                                        <div class="row">
                                            <div class="col-12 form-group">
                                                ...
                                                <input class="form-control" name="{{ $lang->code }}[details]" value="{{ old($lang->code . '.details') }}"/>
                                        ...
                                        <div class="row">
                                            <div class="col-12 form-group">
                                                ...
                                                <textarea id="e-{{  $lang->code  }}-tt" class="c_editor form-control"
                                                          name="{{ $lang->code }}[text]">{{ old($lang->code . '.text') }}</textarea>
