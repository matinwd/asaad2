                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" dir="ltr" name="slug" value="{{ old('slug',fakeInput('slug')) }}"/>
                                    @error('slug')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <pic-single input-name="image" :current-picture="{{ json_encode(\App\Helpers\Helper::renderPictureArray(old('image'),true)) }}"></pic-single>
                                    @error('image')
                                    <div class="v-error">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
                                    <fdp current-date="{{ old('date',fakeInput('2021-01-30')) }}"></fdp>
                                    @error('date')
                                    <div class="v-error">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="tab-pane {{ $i == 0 ? "active" : "" }}" id="{{ $lang->code }}_lang">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 form-group">
                                                ...
                                                <input class="form-control" name="{{ $lang->code }}[title]" value="{{ old($lang->code . '.title',fakeInput($lang->code . '-Title')) }}"/>
                                        ...
                                        <div class="row">
                                            <div class="col-12 form-group">
                                                ...
                                                <textarea id="e-{{  $lang->code  }}-tt" class="c_editor form-control"
                                                          name="{{ $lang->code }}[text]">{{ old($lang->code . '.text',fakeInput($lang->code . '-Text')) }}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-12 form-group">
                                                ...
                                                <input class="input-tags" name="{{ $lang->code }}[tags]" value="{{ old($lang->code . '.tags',fakeInput($lang->code . '-t1,t2,t3')) }}"/>
