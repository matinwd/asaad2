...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('vendors/lfm/img/72px color.png') }}">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css">
{{--    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-rtl/4.1.0/css/bootstrap-rtl.min.css">--}}
    <link rel="stylesheet" href="https://cdn.rtlcss.com/bootstrap/v4.1.3/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css">
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.css">
    <link rel="stylesheet" href="{{ asset('vendors/lfm/css/cropper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendors/lfm/css/dropzone.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendors/lfm/css/mime-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/vendors/lfm/css/lfm.css') }}">
    <link rel="stylesheet" href="{{ asset('fonts/iransans/iran-sans.css') }}">
    <style>
        body {
...
<script src="{{ asset('vendors/lfm/js/cropper.min.js') }}"></script>
<script src="{{ asset('vendors/lfm/js/dropzone.min.js') }}"></script>
<script>
...
<script src="{{ asset('vendors/lfm/js/script.js') }}"></script>
<script>
    ...
    Dropzone.options.uploadForm = {
        ...
        dictFallbackMessage : "مرورگر شما از این عمل(کشیدن و رها کردن) پشتیبانی نمیکند",
        dictInvalidFileType : "نوع فایل آپلود شده مجاز نیست.",
        dictCancelUpload : "انصراف",
        dictCancelUploadConfirmation : "آیا از کنسل کردن آپلود اطمینان دارید؟",
        dictRemoveFile : "حذف فایل",
        dictMaxFilesExceeded : "شما قادر به آپلود فایل های بیشتری نیستید",
        init: function () {
